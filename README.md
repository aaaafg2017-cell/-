...
Arabic-Indic digits, and extra spaces), asks before deleting, and can export
the visible notes as JSON or Markdown. Creating a note while the data file is
unreadable returns `503` with the unavailable persist message rather than
claiming records are invalid.
